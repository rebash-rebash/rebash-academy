...
Complete a real Git workflow for **Signed Commits and Git Security** with commits you can inspect and recover.
...
A delivery team is standardising **Signed Commits and Git Security**. You prototype the workflow in a throwaway repo and capture log evidence for the playbook.
