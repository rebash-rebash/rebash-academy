---
title: Google Cloud
description: "Google Cloud Platform track — planned. Stable URL reserved for future tutorials."
difficulty: beginner
...
Google Cloud Platform services and GCP-native tooling.
...
|-------|------------------|
| [Linux](../linux/index.md) | CLI and systems foundation |
| [Networking](../networking/index.md) | VPC and load balancing concepts |
| [Terraform](../terraform/index.md) | google provider and modules |
| [Kubernetes](../kubernetes/index.md) | GKE-oriented orchestration skills |
