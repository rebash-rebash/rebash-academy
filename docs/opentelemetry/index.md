...
OpenTelemetry will be taught as a production-focused course aligned with REBASH Academy learning paths.

## Learning objectives

- Understand core OpenTelemetry concepts used in Cloud and DevOps roles
