...
- [x] Homepage with learning paths
...
- [x] Hands-on lab catalog (Linux, Docker, Kubernetes, Terraform scenarios)
...
The platform architecture supports future enhancements without structural changes:
