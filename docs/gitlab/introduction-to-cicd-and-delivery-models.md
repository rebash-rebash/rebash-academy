---
title: Introduction to CI/CD and Delivery Models
description: "Introduction to CI/CD and Delivery Models is essential for engineers who operate GitLab CI in production — not only the team"
difficulty: beginner
...
# Introduction to CI/CD and Delivery Models

## Overview

Introduction to CI/CD and Delivery Models is essential for engineers who operate GitLab CI in production — not only the team
that maintains runners. This lesson covers **CI/CD vocabulary, delivery models, and pipeline-as-code with GitLab CI** with practical
...
This is **Tutorial 1** in **Module 1: Foundations** of the REBASH Academy **GitLab CI/CD** track.
...
- [ ] Explain how introduction to ci/cd and delivery models applies in GitLab CI production pipelines
...
![Architecture diagram for Introduction to CI/CD and Delivery Models](../assets/images/introduction-to-cicd-and-delivery-models.svg)
...
### Production notes for Introduction to CI/CD and Delivery Models

Teams standardise GitLab CI templates but still integrate with external systems — container
registries, Kubernetes clusters, and cloud OIDC roles. Document **CI/CD vocabulary, delivery models, and pipeline-as-code with GitLab CI** in your
...
```bash
mkdir -p ~/rebash-cicd/introduction-to-cicd-and-delivery-models && cd ~/rebash-cicd/introduction-to-cicd-and-delivery-models
git init -b main
echo "# Introduction to CI/CD and Delivery Models" > README.md
```
...
## Production Patterns and Deep Dive
        ...
        ### How `Introduction to CI/CD and Delivery Models` fits in real environments
        ...
        and on-call handovers focused on **CI/CD vocabulary, delivery models, and pipeline-as-code with GitLab CI**.
...
```
        ...
        **Scenario:** A teammate merges to `main` and production deploy fails with "permission denied"
        on a step related to **Introduction to CI/CD and Delivery Models**.
        ...
        Bookmark official GitLab documentation for **Introduction to CI/CD and Delivery Models**. Note default runner images, quota
...
- Introduction to CI/CD and Delivery Models is implemented in GitLab CI through `.gitlab-ci.yml`, runners, and merge request workflows
...
1. How does Introduction to CI/CD and Delivery Models work in GitLab CI?
...
!!! tip "Sample answer — question 1"
    GitLab CI expresses Introduction to CI/CD and Delivery Models through `.gitlab-ci.yml` jobs, `stages`, and `rules:`. Merge request pipelines use `CI_PIPELINE_SOURCE=merge_request_event`; default branch pipelines use push sources. Map each concept to the predefined variables GitLab injects.
...
- Next: [Pipeline Anatomy — Stages, Jobs, and Artifacts](pipeline-anatomy-stages-jobs-and-artifacts.md)
