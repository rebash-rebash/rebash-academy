...
description: Mission, vision, learning philosophy, and how REBASH Academy builds production-focused Cloud and DevOps education.
difficulty: beginner
...
| [Interview preparation](../interview/index.md) | Role-oriented question themes |
| Architecture discussions | Patterns under [Architecture](../architecture/index.md) |
| [Certification](../certifications/index.md) support | Map study to industry exams |
...
| [Projects](../projects/index.md) | Portfolio builds |
| [Capstones](../capstones/index.md) | End-to-end proofs across multiple tools |
| [Interview Preparation](../interview/index.md) | Per-technology interview themes |
| [Cheat Sheets](../cheatsheets/index.md) | Quick command and pattern reference |
| [Certifications](../certifications/index.md) | Exam mapping guidance |
| [Architecture](../architecture/index.md) | Cross-cutting design patterns |
| [AI Academy](../ai/index.md) | AI for DevOps and related topics |
...
See the public **[Roadmap](../roadmap.md)** for what is published versus planned.
